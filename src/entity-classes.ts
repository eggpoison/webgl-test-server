...
import Player from "./entities/tribes/OldPlayer";
import Tombstone from "./entities/OldTombstone";
import Tree from "./entities/resources/Tree";
import Workbench from "./entities/Workbench";
import Zombie from "./entities/mobs/OldZombie";
...
import Tribesman from "./entities/tribes/OldTribesman";
import TribeTotem from "./entities/tribes/TribeTotem";
import TribeHut from "./entities/tribes/TribeHut";
import Barrel from "./entities/tribes/OldBarrel";
