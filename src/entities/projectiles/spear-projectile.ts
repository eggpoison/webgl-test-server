...
export function createSpearProjectile(position: Point, tribeMemberID: number, item: Item): Entity {
   ...
   const hitbox = new RectangularHitbox(spear.position.x, spear.position.y, 0.5, 0, 0, HitboxCollisionTypeConst.soft, spear.getNextHitboxLocalID(), spear.rotation, 12, 60, 0);
