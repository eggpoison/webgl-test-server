...
import { CookingEntityComponentArray, HealthComponentArray, InventoryComponentArray } from "../../components/ComponentArray";
...
export function createCampfire(position: Point): Entity {
   ...
   const hitbox = new CircularHitbox(campfire, 2, 0, 0, CAMPFIRE_SIZE / 2);
