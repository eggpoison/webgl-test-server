import { COLLISION_BITS, IEntityType, Point, StructureShapeType } from "webgl-test-shared";
...
export function createBlueprintEntity(position: Point, shapeType: StructureShapeType, tribe: Tribe | null, rotation: number): Entity {
   ...
   BlueprintComponentArray.addComponent(blueprintEntity, new BlueprintComponent(shapeType));
