import { COLLISION_BITS, DEFAULT_COLLISION_MASK, HitboxCollisionTypeConst, IEntityType, ItemType, Point, TreeComponentData, randInt } from "webgl-test-shared";
...
export function createTree(position: Point): Entity {
   ...
   const hitbox = new CircularHitbox(tree.position.x, tree.position.y, mass, 0, 0, HitboxCollisionTypeConst.soft, TREE_RADII[size], tree.getNextHitboxLocalID(), tree.rotation);
