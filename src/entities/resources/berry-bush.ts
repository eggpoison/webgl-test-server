import { BerryBushComponentData, COLLISION_BITS, DEFAULT_COLLISION_MASK, HitboxCollisionTypeConst, IEntityType, ItemType, Point, SettingsConst } from "webgl-test-shared";
...
export function createBerryBush(position: Point): Entity {
   ...
   const hitbox = new CircularHitbox(berryBush.position.x, berryBush.position.y, 1, 0, 0, HitboxCollisionTypeConst.soft, BERRY_BUSH_RADIUS, berryBush.getNextHitboxLocalID(), berryBush.rotation);
