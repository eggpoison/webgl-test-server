...
const A = (entity: Entity, physicsComponent: PhysicsComponent): void => {
...
const B = (entity: Entity, physicsComponent: PhysicsComponent): void => {
...
const C = (entity: Entity, physicsComponent: PhysicsComponent): void => {
...
export function tickPhysicsComponent(entity: Entity): void {
   ...
   A(entity, physicsComponent);
   B(entity, physicsComponent);
   C(entity, physicsComponent);
